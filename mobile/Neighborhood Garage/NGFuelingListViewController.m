...
@implementation NGFuelingListViewController
...
- (NSFetchedResultsController *)fetchedResultsController
{
    ...
    NSEntityDescription *entity = [NSEntityDescription entityForName:@"Fueling" inManagedObjectContext:self.managedObjectContext];
    ...
    NSSortDescriptor *sortDescriptor = [[NSSortDescriptor alloc] initWithKey:@"odometer" ascending:NO];
