...
#import "NGCarsListViewController.h"
#import "NGCarViewController.h"
#import "NGCar.h"

@interface NGCarsListViewController ()
@property (strong, nonatomic) NSFetchedResultsController *fetchedResultsController;
@property (weak, nonatomic) IBOutlet UILabel *nameLabel;
@end

@implementation NGCarsListViewController
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    if ( [[segue identifier] isEqualToString:@"editCar"] ) {
        ...
        NGCar *car  = [[self fetchedResultsController] objectAtIndexPath:indexPath];
        [[segue destinationViewController] setCar:car];
    }
